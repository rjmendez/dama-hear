...
| [decisions/](decisions/) | Numbered, append-only decision records. One per contract or layout decision: what was decided, what evidence forced it, and what it means for forward/rollback/mixed-version behaviour. [0001](decisions/0001-hear-ingest-v1-envelope-and-codec.md) the `hear.ingest.v1` envelope and codec; [0002](decisions/0002-contract-repository-layout.md) the canonical home for published contracts; [0003](decisions/0003-phase2-durable-outbox-postgres-cutover.md) the Phase 2 durable-outbox cut-over (dual-write, backfill, reversal); [0004](decisions/0004-phase4-https-batch-ingest-adapter.md) the Phase 4 additive HTTPS batch ingest adapter; [0005](decisions/0005-phase4-dual-write-observability.md) Phase 4 dual-write observability and reconciliation; [0006](decisions/0006-admin-token-provisioning-policy.md) `HEAR_ADMIN_TOKEN` scope, custody and lifecycle; [0007](decisions/0007-phase5-shadow-read-comparator.md) the Phase 5 shadow-read comparator. |

...
class TestRoundTrips:
    CASES = [(0.0, 0.0, 0.0), (40.2926734, -79.1221263, 234.0), (-33.8688, 151.2093, 58.0),
...
class TestEnuFrame:
    ORIGIN = (40.2926734, -79.1221263, 234.0)
...
class TestTheBugThisReplaces:
    ...
    def test_dropping_height_understates_a_baseline(self):
        ...
        nyq = (40.2926734, -79.1221263, 234.0)
        mach = (40.2926585, -79.1223367, 222.4)
...
class TestSurveyBridge:
    ...
    NODES = [
        {"node_id": 1, "name": "nyquist", "lat_deg": 40.2926734, "lon_deg": -79.1221263,
         "h_ell_m": 234.0},
        {"node_id": 2, "name": "mach", "lat_deg": 40.2926585, "lon_deg": -79.1223367,
         "h_ell_m": 222.4},
        {"node_id": 3, "name": "third", "lat_deg": 40.2928221, "lon_deg": -79.1222104,
         "h_ell_m": 230.0},
    ]
    ...
    def test_separation_survives_the_round_trip(self):
        ...
        direct = G.ecef_distance((40.2926734, -79.1221263, 234.0),
                                 (40.2926585, -79.1223367, 222.4))
    ...
    def test_origin_defaults_to_the_node_centroid_and_is_recorded(self):
        ...
        assert s.origin_geodetic()[0] == pytest.approx(40.29271, abs=1e-4)
    ...
    def test_enu_of_places_a_measured_point_in_the_frame(self):
        ...
        got = s.enu_of(40.2926734, -79.1221263, 234.0)
